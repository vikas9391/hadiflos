...
const Icons = {
  ...
  Scale: () => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3v18M3 9l9-6 9 6M5 21h14M3 9h18M7 21l-4-12M17 21l4-12"/>
    </svg>
  ),
  Search: () => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  Phone: () => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.38a2 2 0 0 1 1.99-2.18h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.36a16 16 0 0 0 6 6l.93-.93a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>
    </svg>
  ),
  Mail: () => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
const T = {
  EN: {
    ...
    hero: {
      badge: "Debt Recovery in Morocco",
      h1a: "Recover What Is",
      h1b: "Rightfully Yours",
      desc: "Local expertise, global reach. We combine amicable negotiation with legal action to recover your unpaid debts. Our multilingual, on-the-ground agents understand Moroccan culture and law.",
    ...
    services: {
      ...
      learn: "Learn more",
      items: [
        { title: "Amicable Collection", desc: "Preserve business relationships while recovering funds through direct negotiation, demand letters, and culturally adapted communication." },
        { title: "Legal Action & Litigation", desc: "Full representation in Moroccan courts, from formal payment demands to enforcement of judgments. Partnered with top local law firms." },
        { title: "Asset Investigation", desc: "Professional location of debtors and asset reports to assess recovery feasibility before investing in legal proceedings." },
        { title: "Portfolio Management", desc: "Complete management of your debt portfolios with real-time reporting and customized dashboards." },
        { title: "Legal Advisory", desc: "Preventive legal guidance to secure your contracts and minimize the risk of future unpaid debts." },
        { title: "Mediation & Arbitration", desc: "Alternative dispute resolution for commercial disputes — fast and cost-effective without going to court." },
      ],
    },
    ...
    about: {
      ...
      values: [
        { title: "Integrity", desc: "We operate with impeccable ethics and complete transparency in all our actions." },
        { title: "Efficiency", desc: "Measurable results through proven methods and unmatched local expertise." },
        { title: "Confidentiality", desc: "Your information and that of your debtors is handled with the strictest confidentiality." },
      ],
    },
    contact: {
  ...
  FR: {
    ...
    hero: {
      badge: "Recouvrement de Créances au Maroc",
      h1a: "Récupérez Ce Qui Vous",
      h1b: "Appartient",
      desc: "Expertise locale, portée internationale. Nous combinons la négociation amiable et l'action en justice pour récupérer vos créances impayées. Nos agents multilingues maîtrisent la culture et le droit marocains.",
    ...
    services: {
      ...
      items: [
        { title: "Recouvrement Amiable", desc: "Préservez vos relations commerciales tout en récupérant vos fonds grâce à la négociation directe et aux lettres de mise en demeure." },
        { title: "Action en Justice", desc: "Représentation complète devant les tribunaux marocains, des injonctions de payer à l'exécution des jugements." },
        { title: "Investigation d'Actifs", desc: "Localisation professionnelle des débiteurs et rapports d'actifs pour évaluer la faisabilité du recouvrement." },
        { title: "Gestion de Portefeuille", desc: "Gestion complète de vos portefeuilles de créances avec reporting en temps réel et tableaux de bord personnalisés." },
        { title: "Conseil Juridique", desc: "Accompagnement juridique préventif pour sécuriser vos contrats et minimiser les risques d'impayés." },
        { title: "Médiation & Arbitrage", desc: "Résolution alternative des litiges commerciaux — rapide et rentable, sans recours aux tribunaux." },
      ],
    },
    ...
    about: {
      ...
      p1: "Forts d'années d'expérience dans le recouvrement de créances au Maroc, nous associons standards internationaux et expertise locale. Notre équipe d'agents multilingues garantit un traitement efficace et éthique de vos dossiers.",
      p2: "Notre mission : récupérer ce qui vous appartient tout en préservant vos relations commerciales. Nous offrons une tarification transparente et des mises à jour régulières tout au long du processus.",
      values: [
        { title: "Intégrité", desc: "Nous agissons avec une éthique irréprochable et une transparence totale dans toutes nos actions." },
        { title: "Efficacité", desc: "Des résultats mesurables grâce à des méthodes éprouvées et une expertise locale inégalée." },
        { title: "Confidentialité", desc: "Vos informations et celles de vos débiteurs sont traitées avec la plus stricte confidentialité." },
      ],
    },
    contact: {
  ...
  AR: {
    ...
    hero: {
      badge: "استرداد الديون في المغرب",
      h1a: "استرد ما يخصك",
      h1b: "بحق وعدالة",
      desc: "خبرة محلية وانتشار دولي. نجمع بين التفاوض الودي والإجراءات القانونية لاسترداد ديونك غير المسددة. وكلاؤنا المتعددو اللغات يفهمون الثقافة والقانون المغربيَّين.",
      btn1: "ابدأ طلبك",
      btn2: "خدماتنا",
    ...
    services: {
      ...
      learn: "اعرف أكثر",
      items: [
        { title: "التحصيل الودي", desc: "الحفاظ على العلاقات التجارية مع استرداد الأموال عبر التفاوض المباشر وخطابات المطالبة." },
        { title: "الإجراءات القانونية", desc: "تمثيل كامل أمام المحاكم المغربية، من أوامر الدفع إلى تنفيذ الأحكام." },
        { title: "التحقيق في الأصول", desc: "تحديد موقع المدينين وإعداد تقارير الأصول لتقييم جدوى الاسترداد." },
        { title: "إدارة المحافظ", desc: "إدارة شاملة لمحافظ الديون مع تقارير فورية ولوحات بيانات مخصصة." },
        { title: "الاستشارة القانونية", desc: "إرشادات قانونية وقائية لتأمين عقودك وتقليل مخاطر الديون المستقبلية." },
        { title: "الوساطة والتحكيم", desc: "حل بديل للنزاعات التجارية — سريع وفعّال دون اللجوء إلى المحاكم." },
      ],
    },
    ...
    why: {
      ...
      desc: "يتطلب البيئة القانونية والتجارية في المغرب معرفة محلية متخصصة. فريقنا مقرّه الدار البيضاء ويعمل بسلاسة مع المحاكم والسلطات المحلية.",
      points: [
    ...
    about: {
      ...
      p1: "بخبرة سنوات في استرداد الديون بالمغرب، نجمع المعايير الدولية مع الخبرة المحلية. يضمن فريقنا من الوكلاء المتعددي اللغات والشركاء القانونيين معالجة مطالباتك بكفاءة وأمانة.",
      p2: "مهمتنا: استرداد ما يخصك مع الحفاظ على علاقاتك التجارية كلما أمكن ذلك. نقدم تسعيراً شفافاً وتحديثات منتظمة طوال العملية.",
      values: [
        { title: "النزاهة", desc: "نعمل بأخلاقيات لا تشوبها شائبة وشفافية كاملة في جميع أعمالنا." },
        { title: "الكفاءة", desc: "نتائج قابلة للقياس من خلال أساليب مجربة وخبرة محلية لا مثيل لها." },
        { title: "السرية", desc: "تُعامَل معلوماتك ومعلومات مدينيك بأقصى درجات السرية والحماية." },
      ],
    },
    contact: {
...
const serviceIcons = [
  ...
  <Icons.BarChart />, <Icons.Shield />, <Icons.Building />,
];
...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .nav-links a {
    text-decoration: none; color: var(--text-mid); font-size: 0.85rem; font-weight: 500;
    letter-spacing: 0.01em; transition: color 0.2s; position: relative; padding-bottom: 3px;
  }
  .nav-links a::after { content: ''; position: absolute; bottom: 0; left: 0; right: 0; height: 1.5px; background: var(--gold); transform: scaleX(0); transition: transform 0.2s; transform-origin: left; }
  ...
  .hero-content {
    ...
    max-width: 1280px; margin: 0 auto; padding: 9rem 2.5rem 8rem;
    width: 100%;
  }
  .hero-eyebrow {
  ...
  .hero h1 {
    ...
    font-weight: 600; line-height: 1.06; color: white;
    margin-bottom: 1.75rem; max-width: 700px;
  }
  [dir="rtl"] .hero h1 { font-family: 'Noto Kufi Arabic', sans-serif; font-size: clamp(2.4rem, 5vw, 4.5rem); }
  ...
  .btn-primary {
    ...
    box-shadow: 0 4px 20px rgba(184,134,11,0.35); transition: all 0.25s;
  }
  ...
  .hero-note em { color: rgba(232,184,75,0.7); font-style: normal; }
  ...
  .section-title {
    ...
    font-weight: 600; text-align: center; color: var(--dark);
  ...
  .section-sub {
    ...
    max-width: 580px; margin: 0 auto 4rem; line-height: 1.75;
    font-size: 0.925rem;
  }
  ...
  .service-card {
    ...
    border-radius: var(--radius-lg); padding: 2.25rem 1.875rem;
  ...
  .service-card.featured {
    background: linear-gradient(150deg, #16110a, #1f1608);
  ...
  /* BANNER */
  .banner {
    background: linear-gradient(135deg, #13100A, #1C1508);
    position: relative; overflow: hidden; padding: 5.5rem 2.5rem;
    text-align: center;
  }
  .banner::before {
  ...
  .process-bg::before {
    content: ''; position: absolute; inset: 0;
    background-image: repeating-linear-gradient(90deg, rgba(184,134,11,0.04) 0, rgba(184,134,11,0.04) 1px, transparent 0, transparent 60px),
                      repeating-linear-gradient(0deg, rgba(184,134,11,0.04) 0, rgba(184,134,11,0.04) 1px, transparent 0, transparent 60px);
  }
  .process-track {
    display: grid; grid-template-columns: repeat(4, 1fr);
  ...
  .process-circle {
    ...
    border: 1.5px solid var(--gold); background: white;
    display: flex; align-items: center; justify-content: center;
    color: var(--gold); position: relative; margin-bottom: 2rem;
  ...
  .why-accent {
    ...
    border-radius: var(--radius); padding: 1.25rem 1.625rem; text-align: center;
  ...
  /* ABOUT */
  .about-bg { background: linear-gradient(160deg, #0D0A06, #191208); padding: 7.5rem 2.5rem; text-align: center; }
  .about-logo-mark {
    width: 80px; height: 80px; border-radius: 50%;
    background: linear-gradient(145deg, var(--gold), var(--gold-light));
    margin: 0 auto 2rem; display: flex; align-items: center; justify-content: center;
    box-shadow: 0 0 0 8px rgba(184,134,11,0.1), 0 4px 24px rgba(184,134,11,0.3);
  }
  .about-logo-mark svg { width: 36px; height: 36px; fill: white; }
  ...
  .value-card {
    ...
    border-radius: var(--radius-lg); padding: 2.25rem 1.875rem; text-align: center;
  }
  .value-icon {
    width: 48px; height: 48px; border-radius: 12px;
    background: rgba(184,134,11,0.15); margin: 0 auto 1.25rem;
    display: flex; align-items: center; justify-content: center;
  ...
  .hours-box {
    ...
    padding: 1.125rem 1.375rem; margin-top: 1.5rem;
  }
  ...
  .wa-pill {
    ...
    background: #22C55E; color: white; padding: 0.375rem 0.875rem;
    border-radius: 50px; font-size: 0.75rem; font-weight: 600; margin-top: 0.875rem;
  }
  ...
  .fcontrol {
    ...
    background: var(--off-white); transition: all 0.2s; outline: none;
  }
  ...
  .btn-submit {
    width: 100%; background: var(--gold); color: white; border: none; cursor: pointer;
    padding: 0.85rem 2rem; border-radius: 8px;
    font-size: 0.9rem; font-weight: 600; letter-spacing: 0.02em;
    font-family: inherit; box-shadow: 0 4px 16px rgba(184,134,11,0.3);
    transition: all 0.2s;
  }
  .btn-submit:hover { background: var(--gold-mid); transform: translateY(-1px); box-shadow: 0 6px 20px rgba(184,134,11,0.4); }
  .form-success { text-align: center; padding: 3.5rem 2rem; color: var(--gold); }
  .form-success-icon { margin-bottom: 1rem; color: #22C55E; }
  .form-success-icon svg { width: 52px; height: 52px; stroke: #22C55E; stroke-width: 1.5; }
  .form-success p { color: var(--text-mid); font-size: 1rem; line-height: 1.7; }
  ...
  .wa-float {
    ...
    display: flex; align-items: center; justify-content: center;
    cursor: pointer; box-shadow: 0 4px 20px rgba(34,197,94,0.45);
  ...
  .toast {
    ...
    background: var(--dark-3); color: white; padding: 0.875rem 1.375rem;
    border-radius: var(--radius); border-left: 3px solid var(--gold);
    box-shadow: 0 8px 32px rgba(0,0,0,0.25);
    animation: toastIn 0.25s ease; font-size: 0.875rem; max-width: 320px;
  }
  ...
  @media (max-width: 960px) {
    ...
    .process-circle { margin-bottom: 0; flex-shrink: 0; }
  }
`;
    ...
    <div dir={t.dir}>
      ...
      <nav className={`nav ${scrolled ? "scrolled" : ""}`}>
        <a href="#home" className="nav-logo" onClick={(e) => { e.preventDefault(); scrollTo("home"); }}>
          <img src={logo} alt="HadiFlosCom" style={{height:"42px",width:"42px",objectFit:"cover",borderRadius:"50%"}} />
        </a>
          ...
          <div className="hero-content">
            ...
            <div className="hero-actions">
              <button className="btn-primary" onClick={() => scrollTo("contact")}>
                <Icons.Claim /> {t.hero.btn1}
              </button>
              <button className="btn-ghost" onClick={() => scrollTo("services")}>
                {t.hero.btn2} <Icons.ChevronDown />
              </button>
            </div>
          ...
          <div className="services-grid">
            {t.services.items.map((s, i) => (
              <div key={i} className={`service-card ${i === 1 ? "featured" : ""}`}>
                <div className="service-icon-wrap">{serviceIcons[i]}</div>
                <div className="service-title">{s.title}</div>
                <div className="service-desc">{s.desc}</div>
                <div className="service-link">{t.services.learn} <Icons.ArrowRight /></div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="banner">
        <div className="banner-inner">
          <h2>{t.banner.h2}</h2>
          <p>{t.banner.p}</p>
          <button className="btn-primary" style={{margin:"0 auto",display:"inline-flex"}} onClick={() => scrollTo("contact")}>
            {t.banner.btn}
          </button>
        </div>
      </div>
            ...
            <div className="why-text">
              ...
              <ul className="why-list">
                {t.why.points.map((p, i) => (
                  <li key={i}>
                    <span className="check-circle"><Icons.Check /></span>
                    {p}
                  </li>
                ))}
              </ul>
              <button className="btn-primary" onClick={() => scrollTo("contact")}>
                {t.why.btn} <Icons.ArrowRight />
              </button>
            </div>
          </div>
        </div>
      ...
      <section id="about" className="about-bg">
        <div className="container">
          <img src={logo} alt="HadiFlosCom" style={{height:"80px",width:"80px",objectFit:"cover",borderRadius:"50%",margin:"0 auto 2rem",display:"block",boxShadow:"0 0 0 6px rgba(184,134,11,0.15), 0 4px 24px rgba(184,134,11,0.25)"}} />
          <div className="eyebrow" style={{color:"var(--gold)"}}>{t.about.label}</div>
          <h2 className="section-title light" style={{marginTop:"0.5rem"}}>{t.about.title}</h2>
          <p className="about-text">{t.about.p1}</p>
          <p className="about-text"><em>{t.about.p2}</em></p>
      ...
      <section id="contact" className="section contact-bg">
        <div className="container">
          <div className="eyebrow">{t.contact.label}</div>
                ...
                <>
                  ...
                  <div className="form-row">
                    <div className="fgroup">
                      <label className="flabel">{t.contact.name} <span className="flabel-req">*</span></label>
                      <input className="fcontrol" placeholder={t.contact.name} value={form.name} onChange={e => setForm({...form, name: e.target.value})} />
                    </div>
                    <div className="fgroup">
                      <label className="flabel">{t.contact.company}</label>
                      <input className="fcontrol" placeholder={t.contact.companyHint} value={form.company} onChange={e => setForm({...form, company: e.target.value})} />
                    </div>
                  </div>
                  <div className="form-row">
                    <div className="fgroup">
                      <label className="flabel">{t.contact.emailF} <span className="flabel-req">*</span></label>
                      <input className="fcontrol" type="email" placeholder="email@example.com" value={form.email} onChange={e => setForm({...form, email: e.target.value})} />
                    </div>
                    <div className="fgroup">
                      <label className="flabel">{t.contact.phoneF} <span className="flabel-req">*</span></label>
                      <input className="fcontrol" placeholder="+212..." value={form.phone} onChange={e => setForm({...form, phone: e.target.value})} />
                    </div>
                  </div>
                  <div className="form-row">
                    <div className="fgroup">
                      <label className="flabel">{t.contact.debtorName} <span className="flabel-req">*</span></label>
                      <input className="fcontrol" placeholder={t.contact.debtorNameHint} value={form.debtorName} onChange={e => setForm({...form, debtorName: e.target.value})} />
                    </div>
                    <div className="fgroup">
                      <label className="flabel">{t.contact.debtorLoc} <span className="flabel-req">*</span></label>
                      <input className="fcontrol" placeholder={t.contact.debtorLocHint} value={form.debtorLocation} onChange={e => setForm({...form, debtorLocation: e.target.value})} />
                    </div>
                  </div>
                  <div className="form-row">
                    <div className="fgroup">
      ...
      <footer>
        <div className="footer-grid">
          <div>
            ...
            <p className="footer-brand-desc">Your trusted partner for debt recovery in Morocco.</p>
          </div>
          <div className="footer-col">
            <h4>{t.footer.links}</h4>
            <ul>
              {navSections.map(([id, key]) => (
                <li key={id}><a href={`#${id}`} onClick={(e) => { e.preventDefault(); scrollTo(id); }}>{getT(key)}</a></li>
              ))}
            </ul>
          </div>
          <div className="footer-col">
