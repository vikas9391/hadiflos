...
const AT = {
  EN: {
    ...
    signInSub: "Sign in with your username or email address",
    ...
    fieldRequired: "Username/email and password are required.",
    ...
    madAcrossAll: "MAD across all claims",
    settled: "Settled",
    ...
    viewAll: "View All",
    view: "View",
    noClaims: "No claims yet. They will appear here once submitted.",
    noMatch: "No claims match your current filters.",
    loadingClaims: "Loading claims…",
    checkingSession: "Checking session…",
    searchPlaceholder: "Search name, ref, debtor…",
    ...
    debtorLocation: "Debtor Location",
    ...
    serverLoadError: "Could not load claims — server error.",
    serverReachError: "Could not reach server. Try refreshing.",
    statusLabels: {
      new: "New", review: "Under Review", in_progress: "In Progress",
      negotiation: "Negotiation", legal: "Legal", settled: "Settled", closed: "Closed",
    },
    debtTypeLabels: {
      commercial: "Commercial", invoice: "Invoice", loan: "Loan Default",
      lease: "Lease / Rent", other: "Other",
    },
  ...
  FR: {
    ...
    signInSub: "Connectez-vous avec votre nom d'utilisateur ou e-mail",
    ...
    fieldRequired: "Nom d'utilisateur/e-mail et mot de passe sont requis.",
    loginFailed: "Échec de la connexion. Veuillez réessayer.",
    serverError: "Impossible de se connecter au serveur.",
    navigation: "Navigation",
    dashboard: "Tableau de bord",
    allClaims: "Tous les dossiers",
    administrator: "Administrateur",
    signOut: "Déconnexion",
    dashboardOverview: "Vue d'ensemble",
    claimsManagement: "Gestion des dossiers",
    totalClaims: "Total Dossiers",
    allTimeSubmissions: "Toutes soumissions",
    totalOwed: "Total Dû",
    madAcrossAll: "MAD sur tous les dossiers",
    settled: "Réglés",
    successfullyResolved: "Résolus avec succès",
    newClaims: "Nouveaux",
    ...
    recentClaims: "Dossiers récents",
    management: "Gestion",
    refresh: "Actualiser",
    viewAll: "Voir tout",
    view: "Voir",
    noClaims: "Aucun dossier pour l'instant. Ils apparaîtront ici une fois soumis.",
    ...
    searchPlaceholder: "Rechercher nom, réf, débiteur…",
    allStatuses: "Tous les statuts",
    showing: "Affichage",
    of: "sur",
    claimDetail: "Détail du dossier",
    submitted: "Soumis le",
    claimantInfo: "Informations du demandeur",
    fullName: "Nom complet",
    emailLabel: "E-mail",
    phone: "Téléphone",
    language: "Langue",
    debtDetails: "Détails de la créance",
    debtorName: "Nom du débiteur",
    debtorLocation: "Localisation du débiteur",
    amountOwed: "Montant dû",
    debtType: "Type de créance",
    description: "Description",
    ...
    serverLoadError: "Impossible de charger les dossiers — erreur serveur.",
    serverReachError: "Impossible d'atteindre le serveur. Actualisez.",
    statusLabels: {
      new: "Nouveau", review: "En examen", in_progress: "En cours",
      negotiation: "Négociation", legal: "Juridique", settled: "Réglé", closed: "Clôturé",
    },
    debtTypeLabels: {
      commercial: "Commercial", invoice: "Facture", loan: "Défaut de prêt",
      lease: "Loyer / Bail", other: "Autre",
    },
  ...
  AR: {
    ...
    signInSub: "سجّل الدخول باسم المستخدم أو البريد الإلكتروني",
    ...
    fieldRequired: "اسم المستخدم/البريد وكلمة المرور مطلوبان.",
    loginFailed: "فشل تسجيل الدخول. يرجى المحاولة مجدداً.",
    serverError: "تعذّر الاتصال بالخادم.",
    navigation: "التنقل",
    dashboard: "لوحة التحكم",
    allClaims: "جميع الطلبات",
    administrator: "مدير",
    signOut: "تسجيل الخروج",
    dashboardOverview: "نظرة عامة",
    claimsManagement: "إدارة الطلبات",
    totalClaims: "إجمالي الطلبات",
    allTimeSubmissions: "جميع الطلبات المقدّمة",
    totalOwed: "إجمالي المستحق",
    madAcrossAll: "درهم عبر جميع الطلبات",
    settled: "مُسوّاة",
    successfullyResolved: "تمّت تسويتها بنجاح",
    newClaims: "جديدة",
    ...
    recentClaims: "الطلبات الأخيرة",
    management: "الإدارة",
    refresh: "تحديث",
    viewAll: "عرض الكل",
    view: "عرض",
    noClaims: "لا توجد طلبات بعد. ستظهر هنا بعد تقديمها.",
    noMatch: "لا توجد طلبات تطابق المرشّحات الحالية.",
    loadingClaims: "جارٍ تحميل الطلبات…",
    checkingSession: "جارٍ التحقق من الجلسة…",
    searchPlaceholder: "ابحث باسم، مرجع، مدين…",
    allStatuses: "جميع الحالات",
    showing: "عرض",
    of: "من",
    claimDetail: "تفاصيل الطلب",
    submitted: "تاريخ التقديم",
    claimantInfo: "معلومات مقدّم الطلب",
    ...
    serverLoadError: "تعذّر تحميل الطلبات — خطأ في الخادم.",
    serverReachError: "تعذّر الوصول إلى الخادم. حاول التحديث.",
    statusLabels: {
      new: "جديد", review: "قيد المراجعة", in_progress: "جارٍ",
      negotiation: "تفاوض", legal: "قانوني", settled: "مُسوّى", closed: "مغلق",
    },
    debtTypeLabels: {
      commercial: "تجاري", invoice: "فاتورة", loan: "تخلف عن سداد",
      lease: "إيجار", other: "أخرى",
    },
    ourExperts: "خبراؤنا",
    team: "الفريق",
  },
...
type AdminTranslation = typeof AT[AdminLang];
...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  :root {
    --gold: #B8860B; --gold-mid: #C9962A; --gold-light: #E8B84B;
    --gold-pale: #FDF5E0; --gold-faint: #FFFBF0;
    --dark: #0D0D0D; --dark-2: #161410; --dark-3: #1E1A14;
    --text: #1C1C1C; --text-mid: #4A4540; --text-light: #7A736A;
    --white: #FFFFFF; --off-white: #FAFAF7;
    --border: #E6DDD0; --border-gold: rgba(184,134,11,0.25);
    --radius: 12px; --radius-lg: 20px; --sidebar-w: 256px;
  ...
  [dir="rtl"] body, [dir="rtl"] * { font-family: 'Noto Kufi Arabic', sans-serif; }
  [dir="rtl"] .sidebar { left: auto; right: 0; border-right: none; border-left: 1px solid rgba(184,134,11,0.1); }
  [dir="rtl"] .main { margin-left: 0; margin-right: var(--sidebar-w); }
  [dir="rtl"] .sidebar-link { border-left: none; border-right: 2px solid transparent; text-align: right; }
  [dir="rtl"] .sidebar-link.active { border-right-color: var(--gold); border-left-color: transparent; }
  [dir="rtl"] thead th { text-align: right; }
  [dir="rtl"] td { text-align: right; }
  [dir="rtl"] .toast { right: auto; left: 1.75rem; border-left: none; border-right: 3px solid var(--gold); }
  [dir="rtl"] .search-icon { left: auto; right: 0.7rem; }
  [dir="rtl"] .search-input { padding: 0.5rem 2.25rem 0.5rem 0.875rem; }
  [dir="rtl"] .pw-toggle { right: auto; left: 0.75rem; }
  [dir="rtl"] .pw-wrap .fcontrol { padding-right: 0.9rem; padding-left: 2.75rem; }
  ...
  [dir="rtl"] .stat-card::after { transform-origin: right; }
  [dir="rtl"] .modal-header { flex-direction: row-reverse; }
  [dir="rtl"] .modal-section-label::after { margin-left: 0; margin-right: 0.5rem; }
  [dir="rtl"] .modal-section-label::before { content: ''; flex: 1; height: 1px; background: var(--border); margin-right: 0; margin-left: 0.5rem; }
  [dir="rtl"] .modal-section-label::after { display: none; }
  [dir="rtl"] .status-update-wrap { flex-direction: row-reverse; }
  [dir="rtl"] .sidebar-brand { flex-direction: row-reverse; }
  [dir="rtl"] .sidebar-footer { text-align: right; }
  [dir="rtl"] .sidebar-user { flex-direction: row-reverse; }
  [dir="rtl"] .btn-logout { flex-direction: row-reverse; }
  [dir="rtl"] .login-card { direction: rtl; }
  [dir="rtl"] .topbar { flex-direction: row-reverse; }
  [dir="rtl"] .topbar-right { flex-direction: row-reverse; }
  [dir="rtl"] .contact-mini { flex-direction: row-reverse; }
  [dir="rtl"] .pagination { flex-direction: row-reverse; }
  [dir="rtl"] .page-btns { flex-direction: row-reverse; }
  [dir="rtl"] .badge { flex-direction: row-reverse; }
  [dir="rtl"] .detail-grid { direction: rtl; }
  [dir="rtl"] .nav-section-label { text-align: right; padding-right: 1.5rem; }
  ...
  .login-card {
    ...
    padding: 3rem 2.75rem; width: 100%; max-width: 420px;
    border: 1px solid rgba(184,134,11,0.15); position: relative; z-index: 1;
    box-shadow: 0 32px 80px rgba(0,0,0,0.5), 0 0 0 1px rgba(184,134,11,0.08);
  }
  .login-lang {
    position: absolute; top: 1.25rem; right: 1.25rem;
    display: flex; gap: 2px; background: var(--border); border-radius: 8px; padding: 3px;
  }
  [dir="rtl"] .login-lang { right: auto; left: 1.25rem; }
  .login-logo {
  ...
  .login-logo h1 { font-family: 'Cormorant Garamond', serif; font-size: 1.6rem; font-weight: 700; color: var(--dark); line-height: 1.1; }
  .login-logo span { font-size: 0.65rem; letter-spacing: 0.2em; color: var(--gold); text-transform: uppercase; font-weight: 600; }
  ...
  .btn-back {
    ...
    padding: 0; margin-bottom: 1.5rem; transition: color 0.2s; text-decoration: none;
  }
  ...
  .pw-toggle {
    ...
    color: var(--text-light); display: flex; align-items: center; justify-content: center; transition: color 0.2s;
  }
  ...
  .btn-primary-full {
    ...
    color: white; border: none; cursor: pointer; padding: 0.85rem; border-radius: 8px;
  ...
  .sidebar-logo-ring {
    ...
    border: 1.5px solid rgba(184,134,11,0.4); overflow: hidden; flex-shrink: 0;
    box-shadow: 0 0 12px rgba(184,134,11,0.15);
  }
  .sidebar-logo-ring img { width: 100%; height: 100%; object-fit: cover; }
  .sidebar-brand-text strong { color: white; font-size: 0.975rem; display: block; font-family: 'Cormorant Garamond', serif; font-weight: 700; line-height: 1.1; }
  ...
  .nav-section-label { font-size: 0.6rem; font-weight: 600; letter-spacing: 0.18em; text-transform: uppercase; color: rgba(255,255,255,0.2); padding: 0.875rem 1.5rem 0.4rem; }
  .sidebar-link {
    display: flex; align-items: center; gap: 0.75rem; padding: 0.7rem 1.5rem;
    cursor: pointer; color: rgba(255,255,255,0.42); font-size: 0.84rem; font-weight: 500;
    transition: all 0.15s; border: none; background: none; width: 100%; text-align: left;
    font-family: inherit; border-left: 2px solid transparent; letter-spacing: 0.01em;
  }
  ...
  .sidebar-user { display: flex; align-items: center; gap: 0.625rem; padding: 0.625rem 0 0.75rem; margin-bottom: 0.75rem; border-bottom: 1px solid rgba(255,255,255,0.05); }
  .sidebar-user-avatar { width: 30px; height: 30px; border-radius: 50%; background: linear-gradient(135deg, var(--gold), var(--gold-light)); display: flex; align-items: center; justify-content: center; color: white; font-size: 0.7rem; font-weight: 700; flex-shrink: 0; }
  ...
  .btn-logout { width: 100%; display: flex; align-items: center; gap: 0.625rem; padding: 0.65rem 0.875rem; border-radius: 8px; background: rgba(220,38,38,0.07); border: 1px solid rgba(220,38,38,0.18); color: rgba(252,165,165,0.75); font-size: 0.82rem; font-weight: 500; cursor: pointer; font-family: inherit; transition: all 0.2s; }
  .btn-logout:hover { background: rgba(220,38,38,0.15); color: #FCA5A5; }
  .btn-logout svg { width: 14px; height: 14px; }

  .lang-switcher-sidebar { display: flex; gap: 2px; background: rgba(255,255,255,0.06); border-radius: 8px; padding: 3px; margin-bottom: 0.75rem; }
  .lang-btn-s { border: none; background: transparent; cursor: pointer; padding: 4px 0; border-radius: 6px; font-size: 0.7rem; font-weight: 600; color: rgba(255,255,255,0.35); letter-spacing: 0.04em; transition: all 0.15s; font-family: inherit; flex: 1; text-align: center; }
  .lang-btn-s.active { background: rgba(184,134,11,0.2); color: var(--gold-light); }

  .main { margin-left: var(--sidebar-w); flex: 1; display: flex; flex-direction: column; min-height: 100vh; }
  .topbar {
    background: rgba(255,255,255,0.97); backdrop-filter: blur(16px);
    border-bottom: 1px solid var(--border); padding: 0 2.25rem; height: 64px;
    display: flex; align-items: center; justify-content: space-between;
    position: sticky; top: 0; z-index: 50; box-shadow: 0 1px 16px rgba(0,0,0,0.04);
  }
  ...
  .topbar-admin { display: flex; align-items: center; gap: 0.5rem; background: var(--gold-pale); border: 1px solid var(--border-gold); padding: 0.35rem 0.875rem; border-radius: 50px; font-size: 0.75rem; font-weight: 600; color: var(--gold-mid); }
  ...
  .stat-card { background: white; border-radius: var(--radius-lg); padding: 1.625rem; border: 1px solid var(--border); display: flex; align-items: flex-start; justify-content: space-between; transition: all 0.2s; position: relative; overflow: hidden; }
  .stat-card::after { content: ''; position: absolute; bottom: 0; left: 0; right: 0; height: 2px; transform: scaleX(0); transform-origin: left; transition: transform 0.3s; }
  ...
  .card-header { padding: 1.375rem 1.75rem; border-bottom: 1px solid var(--border); display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; background: var(--off-white); }
  ...
  .search-input { padding: 0.5rem 0.875rem 0.5rem 2.25rem; border: 1.5px solid var(--border); border-radius: 8px; font-family: inherit; font-size: 0.82rem; color: var(--text); background: white; outline: none; transition: all 0.2s; width: 230px; }
  .search-input:focus { border-color: var(--gold); box-shadow: 0 0 0 3px rgba(184,134,11,0.1); }
  .filter-select { padding: 0.5rem 0.875rem; border: 1.5px solid var(--border); border-radius: 8px; font-family: inherit; font-size: 0.82rem; color: var(--text); background: white; outline: none; cursor: pointer; transition: all 0.2s; }
  .filter-select:focus { border-color: var(--gold); }
  .btn-action { padding: 0.5rem 1rem; border-radius: 8px; border: 1.5px solid var(--border); background: white; font-family: inherit; font-size: 0.8rem; font-weight: 500; color: var(--text-mid); cursor: pointer; display: flex; align-items: center; gap: 0.4rem; transition: all 0.2s; }
  .btn-action:hover { border-color: var(--gold); color: var(--gold); }
  .btn-action svg { width: 13px; height: 13px; }
  .btn-cta { padding: 0.5rem 1.125rem; border-radius: 8px; background: var(--gold); color: white; border: none; font-family: inherit; font-size: 0.8rem; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 0.4rem; transition: all 0.2s; }
  .btn-cta:hover { background: var(--gold-mid); transform: translateY(-1px); }
  .btn-cta svg { width: 13px; height: 13px; }

  /* ── Table ── */
  table { width: 100%; border-collapse: collapse; }
  thead th { padding: 0.75rem 1.25rem; text-align: left; font-size: 0.65rem; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: var(--text-light); background: var(--off-white); border-bottom: 1px solid var(--border); white-space: nowrap; }
  ...
  .td-ref { font-weight: 700; color: var(--gold); font-size: 0.78rem; letter-spacing: 0.04em; }
  ...
  /* ── Badges ── */
  .badge { display: inline-flex; align-items: center; gap: 0.35rem; padding: 0.3rem 0.75rem; border-radius: 50px; font-size: 0.68rem; font-weight: 700; letter-spacing: 0.04em; white-space: nowrap; border: 1px solid; }
  ...
  .tag { display: inline-block; background: var(--gold-pale); color: var(--gold-mid); border: 1px solid var(--border-gold); padding: 0.2rem 0.625rem; border-radius: 4px; font-size: 0.7rem; font-weight: 600; }

  .btn-view { padding: 0.4rem 0.875rem; border-radius: 8px; border: 1.5px solid var(--border-gold); background: var(--gold-pale); font-family: inherit; font-size: 0.78rem; font-weight: 600; color: var(--gold); cursor: pointer; display: inline-flex; align-items: center; gap: 0.35rem; transition: all 0.2s; white-space: nowrap; }
  .btn-view:hover { background: var(--gold); color: white; border-color: var(--gold); }
  .btn-view svg { width: 13px; height: 13px; }

  /* ── Pagination ── */
  .pagination { display: flex; align-items: center; justify-content: space-between; padding: 1rem 1.75rem; border-top: 1px solid var(--border); font-size: 0.78rem; color: var(--text-light); background: var(--off-white); }
  .page-btns { display: flex; gap: 0.3rem; }
  .page-btn { width: 30px; height: 30px; border-radius: 6px; border: 1.5px solid var(--border); background: white; cursor: pointer; font-size: 0.75rem; font-weight: 600; color: var(--text-mid); display: flex; align-items: center; justify-content: center; transition: all 0.15s; font-family: inherit; }
  ...
  /* ── Modal ── */
  .overlay { position: fixed; inset: 0; background: rgba(10,8,4,0.65); z-index: 200; display: flex; align-items: center; justify-content: center; padding: 1.5rem; backdrop-filter: blur(4px); }
  .modal { background: white; border-radius: var(--radius-lg); width: 100%; max-width: 640px; max-height: 92vh; overflow-y: auto; box-shadow: 0 32px 80px rgba(0,0,0,0.4), 0 0 0 1px rgba(184,134,11,0.1); }
  .modal-header { padding: 1.625rem 1.875rem; border-bottom: 1px solid var(--border); display: flex; align-items: flex-start; justify-content: space-between; position: sticky; top: 0; background: white; z-index: 1; }
  ...
  .btn-close { width: 32px; height: 32px; border-radius: 8px; border: 1.5px solid var(--border); background: var(--off-white); cursor: pointer; display: flex; align-items: center; justify-content: center; color: var(--text-light); transition: all 0.2s; flex-shrink: 0; }
  ...
  .modal-section-label { font-size: 0.62rem; font-weight: 700; color: var(--gold); letter-spacing: 0.18em; text-transform: uppercase; margin-bottom: 1rem; display: flex; align-items: center; gap: 0.5rem; }
  ...
  .status-select { flex: 1; padding: 0.65rem 0.875rem; border: 1.5px solid var(--border); border-radius: 8px; font-family: inherit; font-size: 0.875rem; color: var(--text); background: var(--off-white); outline: none; transition: all 0.2s; }
  .status-select:focus { border-color: var(--gold); }
  .btn-save { padding: 0.65rem 1.5rem; background: var(--gold); color: white; border: none; border-radius: 8px; font-family: inherit; font-size: 0.875rem; font-weight: 600; cursor: pointer; transition: all 0.2s; white-space: nowrap; box-shadow: 0 4px 12px rgba(184,134,11,0.3); }
  .btn-save:hover:not(:disabled) { background: var(--gold-mid); transform: translateY(-1px); }
  .btn-save:disabled { opacity: 0.6; cursor: not-allowed; }

  .contact-mini { background: var(--dark); border-radius: var(--radius); padding: 1.25rem; margin-top: 1rem; display: flex; gap: 1rem; flex-wrap: wrap; }
  ...
  .empty-icon { width: 56px; height: 56px; border-radius: 50%; background: var(--gold-pale); color: var(--gold); display: flex; align-items: center; justify-content: center; margin: 0 auto 1.25rem; }
  .empty-icon svg { width: 24px; height: 24px; }
  .empty p { font-size: 0.875rem; }
  .loading { text-align: center; padding: 3.5rem; color: var(--text-light); font-size: 0.875rem; }
  .spin { display: inline-block; width: 20px; height: 20px; border: 2px solid var(--border); border-top-color: var(--gold); border-radius: 50%; animation: spin 0.65s linear infinite; vertical-align: middle; margin-right: 0.5rem; }
  @keyframes spin { to { transform: rotate(360deg); } }

  .toast { position: fixed; bottom: 1.75rem; right: 1.75rem; z-index: 9999; background: var(--dark-3); color: rgba(255,255,255,0.88); padding: 0.875rem 1.375rem; border-radius: var(--radius); border-left: 3px solid var(--gold); font-size: 0.84rem; box-shadow: 0 8px 32px rgba(0,0,0,0.3); animation: toastUp 0.25s ease; max-width: 320px; line-height: 1.5; }
  @keyframes toastUp { from { transform: translateY(16px); opacity: 0; } to { transform: translateY(0); opacity: 1; } }

  .page-loader { min-height: 100vh; display: flex; align-items: center; justify-content: center; background: var(--off-white); }
...
// ─── LANG SWITCHER ────────────────────────────────────────────────────────────
function LangSwitcher({ lang, setLang, dark }: { lang: AdminLang; setLang: (l: AdminLang) => void; dark?: boolean }) {
  return (
    <div style={{
      display: "flex", gap: 2,
      ...
      {(["FR", "EN", "AR"] as AdminLang[]).map(l => (
        <button
          ...
          style={{
            ...
            background: lang === l ? (dark ? "rgba(184,134,11,0.25)" : "white") : "transparent",
            color: lang === l ? (dark ? "var(--gold-light)" : "var(--gold)") : (dark ? "rgba(255,255,255,0.35)" : "var(--text-light)"),
            boxShadow: lang === l && !dark ? "0 1px 4px rgba(0,0,0,0.1)" : "none",
...
// ─── STATUS BADGE ─────────────────────────────────────────────────────────────
function StatusBadge({ status, t }: { status: string; t: AdminTranslation }) {
  const label = t.statusLabels[status as keyof typeof t.statusLabels] || status;
  return (
...
function LoginPage({ onLogin, t, lang, setLang }: LoginPageProps) {
  ...
  const handleLogin = async () => {
    if (!identifier.trim() || !password.trim()) { setError(t.fieldRequired); return; }
    ...
    try {
      ...
      if (res.ok) { setToken(data.access as string); onLogin(data.username as string); }
      else { setError((data.error as string) || t.loginFailed); }
    ...
    <div className="login-wrap" dir={t.dir}>
      <div className="login-card">
        ...
        <div className="fgroup">
          <label className="flabel">{isEmail ? t.emailAddress : t.usernameOrEmail}</label>
          <input
            className="fcontrol"
            placeholder="admin"
            value={identifier}
        ...
        <button className="btn-primary-full" onClick={handleLogin} disabled={loading}>
          {loading
            ? <><span className="spin" style={{ width: 16, height: 16, borderWidth: 2 }} />{t.signingIn}</>
            : t.signIn}
        </button>
      </div>
    </div>
...
function ClaimModal({ claim, onClose, onStatusUpdate, t }: ClaimModalProps) {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (res.ok) { onStatusUpdate(claim.id, status); onClose(); }
    } catch (_) {}
    setSaving(false);
  };
    ...
    <div className="overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal">
        <div className="modal-header">
          <div>
            <div className="modal-eyebrow">{t.claimDetail}</div>
            <div className="modal-title">{claim.full_name}</div>
            <div className="modal-ref">{claim.reference_number} · {t.submitted} {fmtDate(claim.created_at)}</div>
          </div>
          <button className="btn-close" onClick={onClose}><Ico.Close /></button>
        </div>

        <div className="modal-body">
          <div className="modal-section-label">{t.claimantInfo}</div>
          <div className="detail-grid">
            <div><div className="detail-lbl">{t.fullName}</div><div className="detail-val">{claim.full_name}</div></div>
            <div><div className="detail-lbl">{t.company}</div><div className="detail-val">{claim.company_name || "—"}</div></div>
            <div><div className="detail-lbl">{t.emailLabel}</div><div className="detail-val">{claim.email}</div></div>
            <div><div className="detail-lbl">{t.phone}</div><div className="detail-val">{claim.phone}</div></div>
            <div><div className="detail-lbl">{t.language}</div><div className="detail-val">{claim.preferred_language?.toUpperCase() || "—"}</div></div>
            <div><div className="detail-lbl">{t.status}</div><div className="detail-val"><StatusBadge status={claim.status} t={t} /></div></div>
          </div>

          <div className="divider" />
          <div className="modal-section-label">{t.debtDetails}</div>
          <div className="detail-grid">
            <div><div className="detail-lbl">{t.debtorName}</div><div className="detail-val">{claim.debtor_name}</div></div>
            <div><div className="detail-lbl">{t.debtorLocation}</div><div className="detail-val">{claim.debtor_location}</div></div>
            <div><div className="detail-lbl">{t.amountOwed}</div><div className="detail-val gold">{fmt(claim.amount_owed)}</div></div>
            <div>
              <div className="detail-lbl">{t.debtType}</div>
              <div className="detail-val">
                <span className="tag">{t.debtTypeLabels[claim.debt_type as keyof typeof t.debtTypeLabels] || claim.debt_type}</span>
              </div>
            </div>
          </div>

          <div className="detail-desc">
            <div className="detail-lbl">{t.description}</div>
          ...
          <div className="divider" />
          <div className="modal-section-label">{t.updateStatus}</div>
          <div className="status-update-wrap">
            <select className="status-select" value={status} onChange={e => setStatus(e.target.value)}>
              {Object.entries(t.statusLabels).map(([v, l]) => (
...
export default function AdminPage() {
  ...
  const t: AdminTranslation               = AT[lang];
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        const data = await res.json();
        if (data.authenticated) setAuthState(data.username as string);
        else { clearToken(); setAuthState(false); }
  ...
  const fetchClaims = async () => {
    ...
    try {
      ...
      if (res.status === 401) { clearToken(); showToast(t.sessionExpired); setAuthState(false); setLoadingClaims(false); return; }
      if (!res.ok) { showToast(t.serverLoadError); setLoadingClaims(false); return; }
      const data = await res.json();
      setClaims(Array.isArray(data) ? data : (data.results || []));
    } catch { showToast(t.serverReachError); }
    setLoadingClaims(false);
  };

  const handleLogin    = (username: string) => setAuthState(username);
  const handleLogout   = () => { clearToken(); setAuthState(false); setClaims([]); };
  ...
  const settledCnt  = claims.filter(c => c.status === "settled").length;
  const newClaims   = claims.filter(c => c.status === "new").length;

  const navItems = [
    { id: "dashboard" as const, label: t.dashboard,  icon: <Ico.Dashboard /> },
    { id: "claims"    as const, label: t.allClaims,  icon: <Ico.Claims />   },
  ];
      ...
      <div dir={t.dir}>
        ...
        <div className="page-loader">
          <div className="page-loader-inner">
            <span className="spin" />{t.checkingSession}
          </div>
        </div>
      </div>
    );
        ...
        <aside className="sidebar">
          ...
          <div className="sidebar-footer">
            ...
            <div className="lang-switcher-sidebar">
              {(["FR", "EN", "AR"] as AdminLang[]).map(l => (
                <button key={l} className={`lang-btn-s ${lang === l ? "active" : ""}`} onClick={() => setLang(l)}>{l}</button>
              ))}
            </div>
          ...
          <div className="topbar">
            <div>
              ...
              <div className="topbar-title">
                {tab === "dashboard" ? t.dashboardOverview : t.claimsManagement}
              </div>
            </div>
          ...
          <div className="page-content">
              ...
              <>
                <div className="stat-grid">
                  <div className="stat-card gold">
                    <div>
                      <div className="stat-card-label">{t.totalClaims}</div>
                      <div className="stat-card-value">{total}</div>
                      <div className="stat-card-sub">{t.allTimeSubmissions}</div>
                    </div>
                    <div className="stat-icon si-gold"><Ico.Claims /></div>
                  </div>
                  <div className="stat-card amber">
                    <div>
                      <div className="stat-card-label">{t.totalOwed}</div>
                      <div className="stat-card-value" style={{ fontSize: "1.8rem" }}>
                        {(totalAmount / 1000).toFixed(0)}K
                      </div>
                      <div className="stat-card-sub">{t.madAcrossAll}</div>
                    </div>
                    <div className="stat-icon si-amber"><Ico.Money /></div>
                  </div>
                  <div className="stat-card green">
                    <div>
                      <div className="stat-card-label">{t.settled}</div>
                      <div className="stat-card-value">{settledCnt}</div>
                      <div className="stat-card-sub">{t.successfullyResolved}</div>
                    </div>
                    <div className="stat-icon si-green"><Ico.Check /></div>
                  </div>
                  <div className="stat-card blue">
                    <div>
                      <div className="stat-card-label">{t.newClaims}</div>
                      <div className="stat-card-value">{newClaims}</div>
                      <div className="stat-card-sub">{t.awaitingReview}</div>
                    </div>
                ...
                <div className="card">
                  <div className="card-header">
                    <div>
                      <div className="card-eyebrow">{t.latestActivity}</div>
                      <div className="card-title">{t.recentClaims}</div>
                    </div>
                    <div className="card-actions">
                      <button className="btn-action" onClick={fetchClaims}><Ico.Refresh /> {t.refresh}</button>
                      <button className="btn-cta" onClick={() => setTab("claims")}><Ico.Claims /> {t.viewAll}</button>
                    </div>
                  </div>

                  {loadingClaims ? (
                    <div className="loading"><span className="spin" />{t.loadingClaims}</div>
                  ) : claims.length === 0 ? (
                    <div className="empty">
                    ...
                    <table>
                      <thead>
                        <tr>
                          <th>{t.reference}</th><th>{t.claimant}</th><th>{t.debtor}</th>
            ...
            {tab === "claims" && (
              <div className="card">
                <div className="card-header">
                  <div>
                    <div className="card-eyebrow">{t.management}</div>
                    <div className="card-title">{t.allClaims} ({filtered.length})</div>
                  </div>
                  <div className="card-actions">
                ...
                {loadingClaims ? (
                  ...
                  <table>
                    <thead>
                      <tr>
                        <th>{t.reference}</th><th>{t.claimant}</th><th>{t.company}</th>
                        <th>{t.debtor}</th><th>{t.amount}</th><th>{t.type}</th>
                    ...
                    <tbody>
                      {paginated.map(c => (
                        <tr key={c.id}>
                          ...
                          <td>
                            <span className="tag">
                              {t.debtTypeLabels[c.debt_type as keyof typeof t.debtTypeLabels] || c.debt_type}
                            </span>
                          </td>
                          <td><StatusBadge status={c.status} t={t} /></td>
                          <td><span className="td-muted">{fmtDate(c.created_at)}</span></td>
                ...
                <div className="pagination">
                  <span>
                    {t.showing} {Math.min((page - 1) * PER_PAGE + 1, filtered.length)}–{Math.min(page * PER_PAGE, filtered.length)} {t.of} {filtered.length}
                  </span>
